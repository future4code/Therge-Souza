...
function imprimirDespesas(despesas) {
    ...
    despesas.forEach((item) => {
        divDespesas.innerHTML += `<p><b>Valor:</b> ${item.valor} | <b>Descrição:</b> ${item.tipo} | <b>Tipo:</b> ${item.descricao}</p>`
    });
...
function filtrarDespesas() {
    ...
    despesasFiltradas = arrDespesas.filter(item => {
        if (item.valor <= valorMax && item.valor >= valorMin && tipoFiltro === item.tipo) {
